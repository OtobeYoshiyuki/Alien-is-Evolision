...
class CollisionUI :public OtobeLib::TextureBase, OtobeLib::CollisionBase<OtobeLib::ITextureBase>
{
public:
	//コンストラクタ
	CollisionUI(OtobeLib::ITextureBase* texture);

	//デストラクタ
	~CollisionUI()override {};
